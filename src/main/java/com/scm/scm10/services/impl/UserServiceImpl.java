...
public class UserServiceImpl implements UserService {
    ...
    public User saveUser(User user) {
        //First we genrate userid and set it and then we save the user in db
    ...
    public Optional<User> updateUser(User user) {
        ...
        //here if save is null then it will send empty object otherwise it will send the updated object
